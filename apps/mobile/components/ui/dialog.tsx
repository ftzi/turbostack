			...
			<DialogOverlay>
				...
				>
					...
					<DialogPrimitive.Close
						...
						hitSlop={12}
					>
						<Icon as={X} className={cn("web:pointer-events-none size-4 shrink-0 text-accent-foreground")} />
...
function DialogTitle({
	...
	return (
		<DialogPrimitive.Title className={cn("font-semibold text-foreground text-lg leading-none", className)} {...props} />
	)
}
